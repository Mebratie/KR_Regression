...
# %matplotlib inline
dm = pd.read_csv("../../../System/3D_Lotka_Volterra/3D_Lotka_T5_N40/50.csv")
...
def solve_for_lambda(data, c, d, lambda_value, m):
    B501_data = pd.read_csv('../../../Data/3D_Lotka_Volterra/3D_Lotka_T5_N40/B501.csv')
...
data = np.loadtxt('../../../Data/3D_Lotka_Volterra/3D_Lotka_T5_N40/B501.csv', delimiter=',', skiprows=1, usecols=(0, 1, 2))
data_A2 = np.loadtxt('../../../Data/3D_Lotka_Volterra/3D_Lotka_T5_N40/B502.csv', delimiter=',', skiprows=1, usecols=(0, 1, 2))
data_A3 = np.loadtxt('../../../Data/3D_Lotka_Volterra/3D_Lotka_T5_N40/B503.csv', delimiter=',', skiprows=1, usecols=(0, 1, 2))
data_A4 = np.loadtxt('../../../Data/3D_Lotka_Volterra/3D_Lotka_T5_N40/B504.csv', delimiter=',', skiprows=1, usecols=(0, 1, 2))
...
file_path_1 = "../../../Data/3D_Lotka_Volterra/3D_Lotka_T5_N40/B501.csv"
file_path_2 = "../../../Data/3D_Lotka_Volterra/3D_Lotka_T5_N40/B502.csv"
file_path_3 = "../../../Data/3D_Lotka_Volterra/3D_Lotka_T5_N40/B503.csv"
file_path_4 = "../../../Data/3D_Lotka_Volterra/3D_Lotka_T5_N40/B504.csv"
B501_data = pd.read_csv('../../../Data/3D_Lotka_Volterra/3D_Lotka_T5_N40/B501.csv')
df = pd.read_csv("../../../Data/3D_Lotka_Volterra/3D_Lotka_T5_N40/B505.csv")
traj_len = B501_data.groupby('trajectory').size()
rep = int(round(traj_len.mean()))
...
df2 = pd.read_csv('../../../Data/3D_Lotka_Volterra/3D_Lotka_T5_N40/trainingp_data50.csv')
df2['trajectory'] = df2['trajectory'].replace({i: h_value[i-1] for i in range(1, m+1)})
X_train = df2.iloc[:, :-1]
y_train = df2.iloc[:, -1]
X_train.to_csv('../../../results/3D_Lotka_Volterra/3D_Lotka_T5_N40/X_train.csv', index=False)
...
with open("../../../results/3D_Lotka_Volterra/3D_Lotka_T5_N40/candidate_CL.txt", "w") as file:
    file.write(str(updated_ex))
with open("../../../results/3D_Lotka_Volterra/3D_Lotka_T5_N40/candidate_CL.txt", "r") as file:
    updated_ex = sp.sympify(file.read())
df3 = pd.read_csv('../../../Data/3D_Lotka_Volterra/3D_Lotka_T5_N40/holdoutp_data50.csv')
...
dat = pd.read_csv('../../../System/3D_Lotka_Volterra/3D_Lotka_T5_N40/50.csv')
...
print("")
input_directory = r'../../../System/3D_Lotka_Volterra/3D_Lotka_T5_N40'
output_directory = r'../../../Data/3D_Lotka_Volterra/3D_Lotka_T5_N40/d'
df14 = pd.read_csv(os.path.join(input_directory, '50.csv')) # 50.csv, saved names of the data
Br = pd.read_csv('../../../System/3D_Lotka_Volterra/3D_Lotka_T5_N40/50.csv')
...
with open('../../../System/3D_Lotka_Volterra/3D_Lotka_T5_N40/50.csv', 'r') as file:
...
save_path = '../../../results/3D_Lotka_Volterra/3D_Lotka_T5_N40/Relative_Variation.png'
