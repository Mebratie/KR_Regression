...
# %matplotlib inline
dm = pd.read_csv("../../../System/4D_Lotka_Volterra/4D_Lotka_T5_N40/50.csv")
...
def solve_for_lambda(data, c, d, lambda_value, m):
    B501_data = pd.read_csv('../../../Data/4D_Lotka_Volterra/4D_Lotka_T5_N40/B501.csv')
...
data = np.loadtxt('../../../Data/4D_Lotka_Volterra/4D_Lotka_T5_N40/B501.csv', delimiter=',', skiprows=1, usecols=(0, 1, 2, 3, 4, 5, 6, 7))
data_A2 = np.loadtxt('../../../Data/4D_Lotka_Volterra/4D_Lotka_T5_N40/B502.csv', delimiter=',', skiprows=1, usecols=(0, 1, 2, 3, 4, 5, 6, 7))
data_A3 = np.loadtxt('../../../Data/4D_Lotka_Volterra/4D_Lotka_T5_N40/B503.csv', delimiter=',', skiprows=1, usecols=(0, 1, 2, 3, 4, 5, 6, 7))
data_A4 = np.loadtxt('../../../Data/4D_Lotka_Volterra/4D_Lotka_T5_N40/B504.csv', delimiter=',', skiprows=1, usecols=(0, 1, 2, 3, 4, 5, 6, 7))
...
file_path_1 = "../../../Data/4D_Lotka_Volterra/4D_Lotka_T5_N40/B501.csv"
file_path_2 = "../../../Data/4D_Lotka_Volterra/4D_Lotka_T5_N40/B502.csv"
file_path_3 = "../../../Data/4D_Lotka_Volterra/4D_Lotka_T5_N40/B503.csv"
file_path_4 = "../../../Data/4D_Lotka_Volterra/4D_Lotka_T5_N40/B504.csv"
B501_data = pd.read_csv('../../../Data/4D_Lotka_Volterra/4D_Lotka_T5_N40/B501.csv')
df = pd.read_csv("../../../Data/4D_Lotka_Volterra/4D_Lotka_T5_N40/B505.csv")
traj_len = B501_data.groupby('trajectory').size()
rep = int(round(traj_len.mean()))
...
df2 = pd.read_csv('../../../Data/4D_Lotka_Volterra/4D_Lotka_T5_N40/trainingp_data50.csv')
df2['trajectory'] = df2['trajectory'].replace({i: h_value[i-1] for i in range(1, m+1)})
X_train = df2.iloc[:, :-1]
y_train = df2.iloc[:, -1]
X_train.to_csv('../../../results/4D_Lotka_Volterra/4D_Lotka_T5_N40/X_train.csv', index=False)
...
def generate_inner_products(coefficients, terms):
    inner_products = [f"{c}*{t}" for c, t in zip(coefficients, terms)]
    return inner_products
data = pd.read_csv('../../../results/4D_Lotka_Volterra/4D_Lotka_T5_N40/X_train.csv')
...
print("Total sum:")
sp.pprint(total_sum)
with open("../../../results/4D_Lotka_Volterra/4D_Lotka_T5_N40/total_sum.txt", "w") as file:
...
with open("../../../results/4D_Lotka_Volterra/4D_Lotka_T5_N40/total_sum.txt", "w") as file:
    file.write(str(total_sum))
with open("../../../results/4D_Lotka_Volterra/4D_Lotka_T5_N40/total_sum.txt", "r") as file:
    total_sum = sp.sympify(file.read())
df3 = pd.read_csv('../../../Data/4D_Lotka_Volterra/4D_Lotka_T5_N40/holdoutp_data50.csv')
...
dat = pd.read_csv('../../../System/4D_Lotka_Volterra/4D_Lotka_T5_N40/50.csv')
...
plt.xticks([])
plt.yticks([])
save_path = '../../../results/4D_Lotka_Volterra/4D_Lotka_T5_N40/Coerrelation_plot.pdf'
plt.savefig(save_path)
plt.close()
input_directory = r'../../../System/4D_Lotka_Volterra/4D_Lotka_T5_N40'
output_directory = r'../../../Data/4D_Lotka_Volterra/4D_Lotka_T5_N40/d'
...
with open('../../../System/4D_Lotka_Volterra/4D_Lotka_T5_N40/50.csv', 'r') as file:
...
save_path = '../../../results/4D_Lotka_Volterra/4D_Lotka_T5_N40/Relative_Variation.png'
plt.savefig(save_path)
plt.close()
