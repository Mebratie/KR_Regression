...
# %matplotlib inline
dm = pd.read_csv("../../../System/Lorenz_System/Lorenz_System_T5_10/50.csv")
...
def solve_for_lambda(data, c, d, lambda_value, m):
    B501_data = pd.read_csv('../../../Data/Lorenz_System/Lorenz_System_T5_10/B501.csv')
...
data = np.loadtxt('../../../Data/Lorenz_System/Lorenz_System_T5_10/B501.csv', delimiter=',', skiprows=1, usecols=(0, 1, 2, 3))
data_A2 = np.loadtxt('../../../Data/Lorenz_System/Lorenz_System_T5_10/B502.csv', delimiter=',', skiprows=1, usecols=(0, 1, 2, 3))
data_A3 = np.loadtxt('../../../Data/Lorenz_System/Lorenz_System_T5_10/B503.csv', delimiter=',', skiprows=1, usecols=(0, 1, 2, 3))
data_A4 = np.loadtxt('../../../Data/Lorenz_System/Lorenz_System_T5_10/B504.csv', delimiter=',', skiprows=1, usecols=(0, 1, 2, 3))
...
file_path_1 = "../../../Data/Lorenz_System/Lorenz_System_T5_10/B501.csv"
file_path_2 = "../../../Data/Lorenz_System/Lorenz_System_T5_10/B502.csv"
file_path_3 = "../../../Data/Lorenz_System/Lorenz_System_T5_10/B503.csv"
file_path_4 = "../../../Data/Lorenz_System/Lorenz_System_T5_10/B504.csv"
B501_data = pd.read_csv('../../../Data/Lorenz_System/Lorenz_System_T5_10/B501.csv')
df = pd.read_csv("../../../Data/Lorenz_System/Lorenz_System_T5_10/B505.csv")
traj_len = B501_data.groupby('trajectory').size()
rep = int(round(traj_len.mean()))
...
df2 = pd.read_csv('../../../Data/Lorenz_System/Lorenz_System_T5_10/trainingp_data50.csv')
df2['trajectory'] = df2['trajectory'].replace({i: h_value[i-1] for i in range(1, m+1)})
X_train = df2.iloc[:, :-1]
y_train = df2.iloc[:, -1]
X_train.to_csv('../../../results/Lorenz_System/Lorenz_System_T5_10/X_train.csv', index=False)
...
eta = kr_model.eta
x1, x2, x3, x4, x5 = sp.symbols('x1 x2 x3 x4 x5') # all variable
...
ex = sp.sympify(candidate_CL)
factor = 0.0001
substitutions = {
    sp.symbols('x4') * sp.symbols('x3'): factor * sp.symbols('x4') * sp.symbols('x3'),
    sp.symbols('x1')**2: factor * sp.symbols('x1')**2
}
updated_ex = ex.subs(substitutions)
print("Candidate Conservation Law:")
sp.pprint(updated_ex)
print("")
print("")
coefficients = list(updated_ex.as_coefficients_dict().values())
terms = list(updated_ex.as_coefficients_dict().keys())
...
print("")
print("")
with open("../../../results/Lorenz_System/Lorenz_System_T5_10/candidate_CL.txt", "w") as file:
    file.write(str(candidate_CL))
with open("../../../results/Lorenz_System/Lorenz_System_T5_10/candidate_CL.txt", "r") as file:
    candidate_CL = sp.sympify(file.read())
df3 = pd.read_csv('../../../Data/Lorenz_System/Lorenz_System_T5_10/holdoutp_data50.csv')
...
dat = pd.read_csv('../../../System/Lorenz_System/Lorenz_System_T5_10/50.csv')
...
output_directory = r'../../../Data/Lorenz_System/Lorenz_System_T5_10/d'
...
with open('../../../System/Lorenz_System/Lorenz_System_T5_10/50.csv', 'r') as file:
...
compute_function = sp.lambdify((x1, x2, x3, x4, x5), candidate_CL, 'numpy')
...
save_path = '../../../results/Lorenz_System/Lorenz_System_T5_10/Relative_Variation.png'
...
import sympy as sp
a1, a2 = symbols('a1 a2')
perturbed_exp = filtered_exp + a1*x2**2 + a2*x3**2
def add_perturbation(expr, a1, a2):
    x2, x3, x5 = sp.symbols('x2 x3 x5')
    new_expr = perturbed_exp
    return new_expr
x2, x3, x5, a1, a2 = sp.symbols('x2 x3 x5 a1 a2')
ori = filtered_exp
pert = add_perturbation(ori, a1, a2)
print("Candidate Phi:")
sp.pprint(ori)
print("")
print("Perturbed Phi:")
...
f4 = 0
f5 = 0
equation = f1 * diff(Phi, x1) + f2 * diff(Phi, x2) + f3 * diff(Phi, x3) + f4 * diff(Phi, x4) + f5 * diff(Phi, x5)
...
print("")
rewritten_equation = collect(expanded_equation, [x5*x1*x2, x1*x2*x3])
print("Rewritten Equation:")
sp.pprint(rewritten_equation)
print("")
coeff_b_x1_x2 = rewritten_equation.coeff(x5*x1*x2)
coeff_x1_x2_x3 = rewritten_equation.coeff(x1*x2*x3)
eq1 = Eq(coeff_b_x1_x2, 0)
eq2 = Eq(coeff_x1_x2_x3, 0)
solution = solve((eq1, eq2), (a1, a2))
print("Perturbation a1, a2:")
sp.pprint(solution)
solution_a1 = solution[a1]
solution_a2 = solution[a2]
Phi1 = perturbed_exp
Phi1_substituted = Phi1.subs({a1: solution_a1, a2: solution_a2})
print("")
