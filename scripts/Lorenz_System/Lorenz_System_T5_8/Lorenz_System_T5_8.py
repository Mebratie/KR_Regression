...
# %matplotlib inline
dm = pd.read_csv("../../../System/Lorenz_System/Lorenz_System_T5_8/50.csv")
...
def solve_for_lambda(data, c, d, lambda_value, m):
    B501_data = pd.read_csv('../../../Data/Lorenz_System/Lorenz_System_T5_8/B501.csv')
...
data = np.loadtxt('../../../Data/Lorenz_System/Lorenz_System_T5_8/B501.csv', delimiter=',', skiprows=1, usecols=(0, 1, 2, 3))
data_A2 = np.loadtxt('../../../Data/Lorenz_System/Lorenz_System_T5_8/B502.csv', delimiter=',', skiprows=1, usecols=(0, 1, 2, 3))
data_A3 = np.loadtxt('../../../Data/Lorenz_System/Lorenz_System_T5_8/B503.csv', delimiter=',', skiprows=1, usecols=(0, 1, 2, 3))
data_A4 = np.loadtxt('../../../Data/Lorenz_System/Lorenz_System_T5_8/B504.csv', delimiter=',', skiprows=1, usecols=(0, 1, 2, 3))
...
file_path_1 = "../../../Data/Lorenz_System/Lorenz_System_T5_8/B501.csv"
file_path_2 = "../../../Data/Lorenz_System/Lorenz_System_T5_8/B502.csv"
file_path_3 = "../../../Data/Lorenz_System/Lorenz_System_T5_8/B503.csv"
file_path_4 = "../../../Data/Lorenz_System/Lorenz_System_T5_8/B504.csv"
B501_data = pd.read_csv('../../../Data/Lorenz_System/Lorenz_System_T5_8/B501.csv')
df = pd.read_csv("../../../Data/Lorenz_System/Lorenz_System_T5_8/B505.csv")
traj_len = B501_data.groupby('trajectory').size()
rep = int(round(traj_len.mean()))
...
df2 = pd.read_csv('../../../Data/Lorenz_System/Lorenz_System_T5_8/trainingp_data50.csv')
df2['trajectory'] = df2['trajectory'].replace({i: h_value[i-1] for i in range(1, m+1)})
X_train = df2.iloc[:, :-1]
y_train = df2.iloc[:, -1]
X_train.to_csv('../../../results/Lorenz_System/Lorenz_System_T5_8/X_train.csv', index=False)
...
print("")
print("")
with open("../../../results/Lorenz_System/Lorenz_System_T5_8/candidate_CL.txt", "w") as file:
    file.write(str(candidate_CL))
with open("../../../results/Lorenz_System/Lorenz_System_T5_8/candidate_CL.txt", "r") as file:
    candidate_CL = sp.sympify(file.read())
df3 = pd.read_csv('../../../Data/Lorenz_System/Lorenz_System_T5_8/holdoutp_data50.csv')
...
dat = pd.read_csv('../../../System/Lorenz_System/Lorenz_System_T5_8/50.csv')
...
output_directory = r'../../../Data/Lorenz_System/Lorenz_System_T5_8/d'
...
with open('../../../System/Lorenz_System/Lorenz_System_T5_8/50.csv', 'r') as file:
...
save_path = '../../../results/Lorenz_System/Lorenz_System_T5_8/Relative_Variation.png'
